...
input=(
  ...
  'x'           'uav25' '192.168.69.125'
  'a'           'uav26' '192.168.69.126'
  'b'           'uav27' '192.168.69.127'
  'c'           'uav28' '192.168.69.128'
  'd'           'uav29' '192.168.69.129'
  'e'           'uav30' '192.168.69.130'
  'f'           'uav31' '192.168.69.131'
  'g'           'uav32' '192.168.69.132'
  'h'           'uav33' '192.168.69.133'
  'i'           'uav34' '192.168.69.134'
  'j'           'uav35' '192.168.69.135'
  'k'           'uav36' '192.168.69.136'
  'l'           'uav37' '192.168.69.137'
  'm'           'uav38' '192.168.69.138'
  'n'           'uav39' '192.168.69.139'
  'o'           'uav40' '192.168.69.140'
  'p'           'uav41' '192.168.69.141'
...
sudo $VIM_BIN $HEADLESS -Ens -c "set ignorecase" -c "%g/127.0.1.1\s*${my_hostname[i]}$/norm dd" -c "wqa" -- "/etc/hosts"
