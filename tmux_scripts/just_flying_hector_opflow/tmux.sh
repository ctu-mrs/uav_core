...
PROJECT_NAME=just_flying_hector_optflow
...
'
  'ForestFlier' 'waitForRos; roslaunch forest_flier uav.launch
'
  'ForestFlierGo' 'rosservice call  /'"$UAV_NAME"'/forest_flier/goto'
