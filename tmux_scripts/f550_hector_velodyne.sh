...
input=(
  ...
  'Sensors' 'waitForRos; roslaunch mrs_general sensors_hector_velodyne.launch
'
  'Velodyne' 'waitForRos; roslaunch velodyne_pointcloud VLP16_points_to_laserscan.launch
'
  'Hector' 'waitForRos; roslaunch hector_mapping uav.launch
'
  'MRS_control' 'waitForRos; roslaunch mrs_uav_manager f550_hector_velodyne_pixgarm.launch
'
